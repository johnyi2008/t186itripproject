...
import com.yyaccp.common.RandomUtil;
import com.yyaccp.common.RedisAPI;
import com.yyaccp.common.SmsConfig;
...
public class SmsServiceImpl implements SmsService {
    ...
    @Override
    public String send(String mobileNumber) throws Exception {
        ...
        int ex = 5;
        result = restAPI.sendTemplateSMS(mobileNumber,"1" ,new String[]{code,""+ex});

        System.out.println("SDKTestGetSubAccounts result=" + result);
        if("000000".equals(result.get("statusCode"))){
            redisAPI.setEx(mobileNumber,ex*60,code);
            //正常返回输出data包体信息（map）
